...
public abstract class CreeperHandler {
	...
	/**
	 * Record all the blocks in the list as for an explosion. The location
	 * of the explosion is provided.
	 * 
	 * @param list
	 *                The list of blocks.
	 * @param location
	...
	public static void recordBlocks(List<Block> list, Location location) {
		ExplodedBlockManager.processExplosion(list, location, CHExplosionRecordEvent.ExplosionReason.OTHER);
	}

	/**
	 * Record all the blocks in the list as for an explosion. The location
	 * of the explosion is provided, as well as the reason for the
	 * explosion.
	 * 
	 * @param list
	 *                The list of blocks.
	 ...
	 */
	public static void recordBlocks(List<Block> list, Location location, CHExplosionRecordEvent.ExplosionReason reason) {
	 ...
	 *                The cause of the explosion.
	 */
	public static void recordBlocks(EntityExplodeEvent event, CHExplosionRecordEvent.ExplosionReason reason) {
		ExplodedBlockManager.processExplosion(event, reason);
	}

	/**
	 * Record a block to be replaced later, and remove it from the world.
	 * The surrounding blocks, if dependent on it, are taken care of.
	 * 
	 * @param block
	 *                The block to record.
	 */
	...
	/**
	 * Get whether the explosion created by this entity should remove
	 * protection of blocks protected by LWC.
	 * 
	 * @param entity
