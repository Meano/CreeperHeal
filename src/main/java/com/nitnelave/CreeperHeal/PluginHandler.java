...
public class PluginHandler {
	...
	private static boolean creeperTrap = false, lockette = false,
			spout = false;
	...
	/*
	 * Check if the plugin is active on the server, and if so, display a
	 * message stating that it was successfully detected.
	 */
