...
public abstract class CreeperLog {
	...
	/*
	 * The verbosity level. Initialized at -42 as an arbitrary value, to
	 * detect that it hasn't been loaded from the config yet.
	 */
	...
	/**
	 * Display an information message to the console, if the verbosity is
	 * high enough, i.e. if level is lower or equals to the log level.
	 * 
	 * @param msg
	...
	/**
	 * Display the type and the location of a block in a formatted way. If
	 * force is true, then it is a warning (as part of a warning message).
	 * Otherwise it is a debug message.
	 * 
	 * @param block
