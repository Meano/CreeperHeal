...
public abstract class NeighborFinder<T> {
	...
	/**
	 * Add an element to the map. It is placed in the correct zone, created
	 * if necessary.
	 * 
	 * @param el
	 *                The element.
	...
	/**
	 * Get whether the location is "close" to an element. The actual
	 * definition of "close" is in the overridden methods of the children
	 * classes.
	 * 
	 * @param loc
	...
	/**
	 * Get a neighbor of the location provided. It is not guaranteed to be
	 * the closest, but it is an element which satisfies the condition of a
	 * neighbor.
	 * 
	 * @param loc
