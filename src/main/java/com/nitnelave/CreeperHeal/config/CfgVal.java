...
public enum CfgVal implements CfgValEnumMember {
	...
	REPLACE_PROTECTED_CHESTS(
			"replace-protected-chests-immediately",
			false,
			false),
	...
	SORT_BY_RADIUS(
			"performance.sort-exploded-blocks-by-distance",
			true,
			true),
	...
	/*
	 * Get whether this value is in the advanced file or the config file.
	 * Return true if it is in the advanced file.
	 */
