...
class CreeperComparator implements Comparator<Replaceable> {
	...
	/**
	 * Constructor. Order between blocks with the same dependency status and
	 * at the same level is undefined.
	 */
	...
	/**
	 * Constructor. The blocks are ordered as a last criterion by distance
	 * fron the explosion, the closest first.
	 * 
	 * @param loc
