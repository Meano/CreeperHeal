...
public interface Replaceable {
	...
	/**
	 * Replace the block in the world. In case of a dependent item whose
	 * support is absent, the boolean shouldDrop determines whether the
	 * replacement is postponed or if the item should be dropped.
	 * 
	 * @param shouldDrop
	 *                If true, the item will drop, otherwise its replacement
	 *                will be postponed.
	 ...
	 * dependent.
	 * 
	 * @return The blockFace the block is attached by, SELF if the block is
	 *         not dependent.
	 */
	 ...
	 * 
	 * @param forced
	 *                If false, the block is dropped only according to the
	 *                drop chance in the config.
	...
	/**
	 * Delay the block's replacement until it is possible for it to spawn,
	 * or drop it after a reasonable amount of tries.
	 * 
	 * @param reason
