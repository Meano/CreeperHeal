...
public class CreeperExplosion {
	...
	/**
	 * Add blocks to an explosion, and reset the timer to the time of the
	 * last explosion.
	 * 
	 * @param blocks
	...
	/*
	 * Get the distance between the explosion's location and the furthest
	 * block.
	 */
	...
	/**
	 * Get the radius of the explosion (i.e. the distance between the
	 * location and the furthest block).
	 * 
	...
	/*
	 * In case of possible obsidian destruction, check for obsidian around,
	 * and give them a chance to be destroyed.
	 */
	...
	/**
	 * Check if the explosion has blocks to repair, and repair them (or one
	 * of them in case of block per block).
	 * 
	...
	/**
	 * Get whether the explosion has started replacing (only in block per
	 * block mode).
	 * 
