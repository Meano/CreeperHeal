...
public class CreeperBlock implements Replaceable {
	 ...
	 */
	private final static Set<Integer> DEPENDENT_DOWN_BLOCKS = CreeperUtils.createFinalHashSet(6, 26, 27, 28, 31, 32, 37, 38, 39, 40, 55, 59, 63, 64, 66, 70, 71, 72, 78, 81, 83, 93, 94, 104, 105, 115, 117, 132, 140, 141, 142, 171);
	/*
	...
	/**
	 * Create a new CreeperBlock of the right class. Factory method that
	...
	public static CreeperBlock newBlock(BlockState state) {
		...
		// if (PluginHandler.isSpoutEnabled () &&
		// SpoutBlock.isCustomBlock (blockState))
	 ...
	 *
	 * @param forced
	 *                If false, the block will have a chance to drop,
	 *                according to the configuration value of the drop
	 *                chance. If true, the block drops every time.
	...
	/*
	 * Get whether the block is empty, i.e. if a player can breathe inside
	 * it and if it can be replaced by other blocks (snow, water...)
	 */
	...
	/*
	 * Test the blocks directly in contact, and if they are ascending rails,
	 * add them to the updatePrevention list.
	 */
	 ...
	 * check if they really are, simply check that
	 * neighborBlock.isNeighbor() is true.
	 *
