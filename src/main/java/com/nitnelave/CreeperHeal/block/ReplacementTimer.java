...
public class ReplacementTimer {
	 ...
	 * @param timed
	 *                Whether the replacement is in a world where
	 *                replacements are timed, i.e. happen at a certain hour
	 ...
	 * 
	 * @return The recorded time. Either the time the block was burnt or
	 *         later if the replacement has been delayed.
	 */
	public Date getTime() {
		return time;
	}
	...
	/**
	 * Get whether the replacement is in a world with timed repairs (repairs
	 * at a specific hour).
	 * 
