...
public class BlockId {
	...
	/**
	 * Constructor from string. The string is parsed in an attempt to get
	 * the info. The string format accepted is a simple number for just the
	 * id, or id:data for both.
	 * 
	 * @param str
