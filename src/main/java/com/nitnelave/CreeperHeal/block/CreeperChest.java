...
class CreeperChest extends CreeperBlock {
	...
	/*
	 * Get the total inventory : it is either the normal one, or in case of
	 * a double chest, the combined inventory of both chests.
	 */
	...
	/*
	 * Get the other chest of the double chest. null if it is a simple
	 * chest.
	 */
	@SuppressWarnings("deprecation")
