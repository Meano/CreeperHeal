...
public class RailsIndex {
	...
	/**
	 * Get whether the location is next to a block whose update is
	 * prevented.
	 * 
	 * @param block
	 *                The block to check.
	 ...
	 * block's updates are prevented until after 200 times the block per
	 * block replacement interval.
	 * 
	 * @param block
	 *                The block.
	 */
