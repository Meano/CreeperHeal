...
public class CreeperListener implements Listener {
	...
	/**
	 * Listener for the EntityChangeBlockEvent. Check for Endermen picking
	 * up blocks.
	 * 
	 * @param event
	...
	public void onEntityChangeBlock(EntityChangeBlockEvent event) {
		if (event.getEntityType() == EntityType.SILVERFISH && event.getBlock().getType() == Material.MONSTER_EGGS && CreeperConfig.getBool(CfgVal.REPLACE_SILVERFISH_BLOCKS))
	...
	/**
	 * Listener for the EntityBreakDoorEvent. Record doors broken by
	 * zombies.
	 * 
	 * @param event
