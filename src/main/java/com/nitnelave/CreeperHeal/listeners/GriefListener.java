...
public class GriefListener implements Listener {
	...
	/**
	 * Listener for the BlockPlaceEvent. If the player does not have the
	 * rights to place a block, the event is cancelled, and the appropriate
	 * warnings are fired.
	 *
	 * @param event
	 *                The BlockPlaceEvent.
	...
	/**
	 * Listener for the BlockIgniteEvent. If fire spreading or fire from
	 * lava is disabled, cancel the event.
	 *
	 * @param event
